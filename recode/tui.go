...
func newModel(justProgress bool, files ...string) recodeModel {
...
func encode(m recodeModel) {
    ...
    err := Encode(m.srcFile, m.destFile, m.channel)
...
func Tui(justProgress bool, src, dest string) error {
